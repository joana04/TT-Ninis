...
<html>
    ...
    <body>
        ...
        <div class="container animated fadeIn delay-10ms">
            <div class="row ">
                <div class="col-12">
                    <h2>Vinculación Laboral - Administrador</h2>
                    <hr>
                </div>
                <div class="col-md-4 col-xs-12"> 
                    <div class="card border-info mb-3" style="max-width: 20rem;">
                        ...
                        <div class="card-body">
                          ...
                          <p class="card-text">Muestra los becarios registrados</p>
                ...
                <div class="col-md-4 col-xs-12">
                    <div class="card border-info mb-3" style="max-width: 20rem;">
                        <div class="card-header"> </div>
                        <div class="card-body">
                          <h4 class="card-title">Ver empresas</h4>
                          <p class="card-text">Muestra las empresas registradas</p>
