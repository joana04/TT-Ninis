    ...
    <body >
        ...
        <div class="container">
            <div class="row ">
                <div class="col-10 center-auto">
                    ...
                    <form action='editBecarioUbicacion.htm' method="POST" >
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        <input class="form-control" type="text" 
                                               name="numeroExterior" 
                                               value="${direccion.getNumeroExterior()}"
                                               required/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6">
                                        <input class="form-control" type="text" 
                                               name="numeroInterior"
                                               value="${direccion.getNumeroInterior()}"
                                               />
                                    </div>
                                    <div class="col-xs-12 col-sm-6" >
                                        <input class="form-control" type="text" 
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6">
                                        <input class="form-control" type="text" 
                                               ...
                                               pattern="[a-zA-Z ]{1,60}"
                                               value="${direccion.getMunicipioDelegacion()}"
                                               required/>
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        <input class="form-control" type="text" 
                                               ...
                                               value="${direccion.getCodigoPostal()}"
                                               required/>
                                    </div>
                                </div>
        ...
        <script type="text/javascript">
             $(document).ready(function(){
                $("#entidadSelect").val("${direccion.getEntidadFederal()}");
            });
